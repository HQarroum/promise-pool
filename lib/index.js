...
class Pool {
  ...
  /**
   * Registers a callback function to be called
   * before each enqueuing operation of a scheduled
   * runnable.
   * @param {*} f a callback function to call.
   */
  beforeEnqueueEach(f) {
    this.strategy.beforeEnqueueEach(f);
    return (this);
  }
   ...
   */
  removeBeforeEach(f) {
    this.strategy.removeBeforeEach(f);
    return (this);
  }
  ...
  removeBeforeEnqueueEach(f) {
    this.strategy.removeBeforeEnqueueEach(f);
    return (this);
  }
  ...
  /**
   * Registers a callback function to be called
   * after each enqueuing operation of a scheduled
   * runnable.
   * @param {*} f a callback function to call.
   */
  afterEnqueueEach(f) {
    this.strategy.afterEnqueueEach(f);
    return (this);
  }
   ...
   */
  removeAfterEach(f) {
    this.strategy.removeAfterEach(f);
    return (this);
  }
  ...
  removeAfterEnqueueEach(f) {
    this.strategy.removeAfterEnqueueEach(f);
    return (this);
  }

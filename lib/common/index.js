...
/**
 * @return an uninitialized promise descriptor having the index `idx`.
 * @param {*} idx the index to associate with the promise.
 */
exports.promise = (idx) => ({ load: 0, idx, promise: Promise.resolve() });
